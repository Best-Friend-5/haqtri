...
import './Footer.css';
import logo from '../images/logoo.png'; // Importing the logo as in Navbar
    ...
    <footer className="footer">
      <div className="footer-container">
        <div className="footer-column footer-logo">
          ...
          <p className="footer-logo-text">lOGO</p>
        </div>

        <div className="footer-column">
          <h3 className="footer-title">Contact Info</h3>
          <p>
            Email: <a href="mailto:info@twinkletoesschools.com">info@WEBLINK.COM</a>
          </p>
          <p>
            Phone: <a href="tel:+1234567890">+123 456 7890</a>
          </p>
          <p>Address: abuja area</p>
        </div>
      ...
      <div className="footer-bottom">
        <p>&copy; {new Date().getFullYear()} Abztech Innovations. All Rights Reserved.</p>
        <button
